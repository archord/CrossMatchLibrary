...
void CrossMatch::match(char *refName, char *objName, float errorBox, int *idxs) {

  refStarFile = new StarFile();
  refStarFile->readStar(refName, idxs);
  objStarFile = new StarFile();
  objStarFile->readStar(objName, idxs);
...
void CrossMatch::printMatchedPair(char *outfName, CMStar *tStar, float errorBox) {
